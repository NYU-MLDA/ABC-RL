...
trainTestBenchmarkSplit = {
    ...
    5001 : [['alu2', 'apex3', 'apex5', 'b2', 'c1355', 'c5315', 'c2670', 'prom2', 'frg1', 'i7', 'i8', 'm3', 'max512', 'table5','adder','div','log2','sin','sqrt','multiplier','max','square','bar','cavlc','ctrl','i2c','int2float','mem_ctrl','priority','router','arbiter','voter'],['sin']]   
}
